...
Config:SetDefaults({
    ...
    settings = {fov = 90, showFov = true, fovColor = "Red", smoothness = 1.0, walkSpeed = 25, flySpeed = 150},
    binds = {},
})
Config:Load()
...
if aimbotToggle then Keybinds:Register("aimbot", {Name = "Aimbot", Toggle = aimbotToggle}) end
...
game:GetService("RunService").Heartbeat:Connect(function() Keybinds:UpdateStates() end)
